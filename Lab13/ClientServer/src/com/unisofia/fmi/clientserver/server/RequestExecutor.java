package com.unisofia.fmi.clientserver.server;
...
import com.unisofia.fmi.clientserver.R;
import com.unisofia.fmi.clientserver.server.request.BaseRequest;
...
public final class RequestExecutor {
	...
	public static <T> boolean sendRequest(Context context,
			BaseRequest<T> request, ResponseListener<T> listener) {
	...
	private static class ExecutorTask<T> extends AsyncTask<Void, Void, T> {
		...
		public ExecutorTask(Context context, BaseRequest<T> request,
		...
		protected T doInBackground(Void... params) {
			...
			try {
				...
				if (statusCode >= 200 && statusCode < 300) {
					...
					Log.e("error", "Server responded with error status code: "
							+ statusCode);
				}
